...
IFX_CONST IfxFlash_flashSector IfxFlash_dFlashTableEepLog[IFXFLASH_DFLASH_NUM_LOG_SECTORS] = {
    {0xAF000000 + 0 * 0x2000,  0xAF000000 + 1 * 0x2000 - 1 },	// 0xAF00 0000-0xAF00 1FFF  8K字节
    {0xAF000000 + 1 * 0x2000,  0xAF000000 + 2 * 0x2000 - 1 },	// 0xAF00 2000-0xAF00 3FFF  8K字节
    {0xAF000000 + 2 * 0x2000,  0xAF000000 + 3 * 0x2000 - 1 },	// 0xAF00 4000-0xAF00 5FFF  8K字节
    {0xAF000000 + 3 * 0x2000,  0xAF000000 + 4 * 0x2000 - 1 },	// 0xAF00 6000-0xAF00 7FFF  8K字节
    {0xAF000000 + 4 * 0x2000,  0xAF000000 + 5 * 0x2000 - 1 },	// 0xAF00 8000-0xAF00 9FFF  8K字节
    {0xAF000000 + 5 * 0x2000,  0xAF000000 + 6 * 0x2000 - 1 },	// 0xAF00 A000-0xAF00 BFFF  8K字节
    {0xAF000000 + 6 * 0x2000,  0xAF000000 + 7 * 0x2000 - 1 },	// 0xAF00 C000-0xAF00 DFFF  8K字节
    {0xAF000000 + 7 * 0x2000,  0xAF000000 + 8 * 0x2000 - 1 },	// 0xAF00 E000-0xAF00 FFFF  8K字节
    {0xAF000000 + 8 * 0x2000,  0xAF000000 + 9 * 0x2000 - 1 },	// 0xAF01 0000-0xAF01 1FFF  8K字节
    {0xAF000000 + 9 * 0x2000,  0xAF000000 + 10 * 0x2000 - 1},	// 0xAF01 2000-0xAF01 3FFF  8K字节
    {0xAF000000 + 10 * 0x2000, 0xAF000000 + 11 * 0x2000 - 1},	// 0xAF01 4000-0xAF01 5FFF  8K字节
    {0xAF000000 + 11 * 0x2000, 0xAF000000 + 12 * 0x2000 - 1},	// 0xAF01 6000-0xAF01 7FFF  8K字节
    {0xAF000000 + 12 * 0x2000, 0xAF000000 + 13 * 0x2000 - 1},	// 0xAF01 8000-0xAF01 9FFF  8K字节
    {0xAF000000 + 13 * 0x2000, 0xAF000000 + 14 * 0x2000 - 1},	// 0xAF01 A000-0xAF01 BFFF  8K字节
    {0xAF000000 + 14 * 0x2000, 0xAF000000 + 15 * 0x2000 - 1},	// 0xAF01 C000-0xAF01 DFFF  8K字节
    {0xAF000000 + 15 * 0x2000, 0xAF000000 + 16 * 0x2000 - 1},	// 0xAF01 E000-0xAF01 FFFF  8K字节
};
