...
#define LCF_INTVEC0_START   0x80090000
#define LCF_TRAPVEC0_START  0x80098000

#define INTTAB0             (LCF_INTVEC0_START)
#define TRAPTAB0            (LCF_TRAPVEC0_START)

#define RESET               0x80020020
...
//            select "*.bmhd_1";
//        }
        group  reset (ordered, run_addr=0x80020020)
        {
            select "*.start";
        }
        group  interface_const (ordered, run_addr=0x80020040)
        {
	...
	section_layout mpe :vtc :linear		//s20-s22   384kB
	{
		group Reserve_s20_s22 (ordered, contiguous, run_addr = 0xA00A0000)
		{
		    reserved "Reserve_s20_s22" (size = 384k, attributes = r);
		}
	}
